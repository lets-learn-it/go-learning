...
import (
	...
	apiv1 "github.com/pskp-95/StaticPage/api/v1"
...
func (r *reconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	var staticPage apiv1.StaticPage
	...
	if err != nil {
		if k8serrors.IsNotFound(err) {
			configMap := getConfigMapObject(staticPageName, staticPage.Spec.Contents)
			...
			deployment := getDeploymentObject(staticPageName, staticPage.Spec.Image, staticPage.Spec.Replicas)
...
func getDeploymentObject(name, image string, replicas int) *appsv1.Deployment {
